...
export default function Navbar() {
  ...
  const { toggleTheme, isDarkMode } = useThemeContext(); // Access theme context
  ...
  return (
    <Box sx={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px" }}>
      <BottomNavigation showLabels value={value} onChange={handleNavigation} sx={{ flexGrow: 1 }}>
